"""
config.py — runtime settings for: Support-mailbox-automation
...
# (one variable per MCP server instance; populated from .env)
# ---------------------------------------------------------------------------
MCP_MYEMAILMCPSERVER_ENDPOINT = os.getenv("MCP_MYEMAILMCPSERVER_ENDPOINT", "https://mcp-myemailmcpserver.thankfulmushroom-e8ac5ce8.swedencentral.azurecontainerapps.io/mcp")
